...
filenameBasket <- paste("K:\\RANDD\\99-Misc\\Bastiaan\\R-programms\\PCA_index_subbasket_selection\\AEX_basket.txt",sep="")
...
# ####################
    ...
    filename <- paste("C:\\stoxx600_daily_quotes\\AEX Index.csv",sep="")
